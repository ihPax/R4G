        ...
        <dd class="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
          <li class="pl-3 pr-4 py-1 xs:py-2 flex items-center justify-between text-sm">
            <div class="w-0 flex-1 flex items-center">
              <div v-if="!isEdit || field.type =='email' " class="ml-2 flex-1 w-0 truncate mb-1"> {{ field.isPasswordHidden != undefined ? "********" : field.code }}</div>
              <div v-else class="w-full">
                ...
                />
                <span v-if="field.isPasswordHidden == true" @click="toggleVisibility(field, 'text')" class="absolute -ml-8 cursor-pointer">
                ...
                <span v-if="field.isPasswordHidden == false" @click="toggleVisibility(field, 'password')" class="absolute -ml-8 cursor-pointer">
                  <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000">
